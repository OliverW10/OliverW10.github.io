...
export const allProjects: CardInfo[] = [
  ...
  },
  {
    ...
    more_info: "Pacman made using pygame with various AI's to control both the ghosts and pacman. Some of the implimented AI's were: game tree search, imitation and adversarial(incomplete) machine learning, heuristic algorithms, recreation of origonal game's ghost AI.",
  ...
  },
  {
    ...
    more_info: "Used react and the spotify api. Not in particularly finished state.",
